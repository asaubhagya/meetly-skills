...
guide through `setup` (or `get_meetly_usage_guide` when setup is unavailable) for each new brief. Apply the current request over saved
...
Use [Meetly editorial standards](references/editorial.md) for book-like clarity and
readable PDF/HTML. Honor language, tone, depth and delivery preferences.
